function isedge = find_edge_cases(CC, oo, resolution, maskToken, bz, bxy)
...
numslices = double(zrange(2) - zrange(1) + 1);

N_row = ranges(2);
M_col = ranges(1);
goodPixelFile = zeros(N_row, M_col, numslices, 'uint8');

localInd = 1; 
for n = zrange(1):1:zrange(2)
